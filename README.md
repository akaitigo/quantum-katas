...
![Kata List](docs/images/kata-list.png)

カテゴリ別にグループ化された10段階のカタ。難易度バッジ、前提条件、完了状態を一覧表示。

### カタ詳細 + コードエディタ

![Kata Detail](docs/images/kata-detail.png)

各カタの解説（Markdown）と穴埋めテンプレートコード。

![Code Editor](docs/images/kata-editor.png)

Monaco Editor（Python シンタックスハイライト）+ 実行結果パネル。`# YOUR CODE HERE` を埋めて実行。
...
- **Backend**: 182 テスト, カバレッジ 92% (80% 必須)
